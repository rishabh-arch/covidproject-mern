        ...
        <Helmet>
            ...
            <form className="form-right">
                ...
                <div className="form-field">
                    <input type="submit" value="Login" ref={focusPoint} className="register" name="register" onClick={submitData}/>
                    {
                        loading ? <>
            ...
            <h2 className="text-uppercase">information</h2>
                ...
                <div className="form-field">
                    <NavLink to="/registration"><input type="button" className="account" value="Click to Register"/></NavLink>
                </div>
            </div>
        </div>
